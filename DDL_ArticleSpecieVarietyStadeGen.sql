...
CREATE TABLE variety (IDVARIETY VARCHAR(50) NULL , IDSPECIE VARCHAR(50) NULL , PRIMARY KEY (IDVARIETY, IDSPECIE)) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE generation (IDGENERATION VARCHAR(50) NULL , DESCRIPTION VARCHAR(50) NULL, PRIMARY KEY (IDGENERATION));
CREATE TABLE stage (IDSTAGE VARCHAR(50) NULL , PRIMARY KEY (IDSTAGE));
