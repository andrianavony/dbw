...
START TRANSACTION;
ALTER TABLE article ADD CONSTRAINT FK_article_IDVARIETY 
                    FOREIGN KEY         (IDVARIETY) 
                    REFERENCES variety  (IDVARIETY);
COMMIT;
START TRANSACTION;
ALTER TABLE article ADD CONSTRAINT FK_article_IDSTAGE 
                    FOREIGN KEY         (IDSTAGE) 
                    REFERENCES STAGE    (IDSTAGE);
COMMIT;
START TRANSACTION;
ALTER TABLE article ADD CONSTRAINT FK_article_IDSPECIE 
                    FOREIGN KEY         (IDSPECIE) 
                    REFERENCES specie   (IDSPECIE);
COMMIT;

START TRANSACTION;
ALTER TABLE article ADD CONSTRAINT FK_article_IDGENERATION 
